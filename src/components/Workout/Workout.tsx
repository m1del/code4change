...
export default function Workout() {
  ...
  async function getResponse(difficulty : string, type_workout : string, num_days: string) {
    const response = await sendWorkoutPlanRequest(difficulty, type_workout, num_days);
          ...
          <div className="w-full">
            <Carousel>
              <CarouselContent>
                ...
                {loaded && workouts.map((workout, index) => (
